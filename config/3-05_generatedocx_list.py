...
# 定义Excel文件和Word模板路径
excel_file_path = r"./template/main/export.xlsx"
word_template_path = r"./template/main/list15/temp.docx"
...
# 获取A2单元格的内容作为文件名
output_file_name = sheet['A2'].value
