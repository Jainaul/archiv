...
# Excel 文件路径
excel_file = r".\template\minor\export.xlsx"
...
docx_file = os.path.join(script_path, 'template', 'minor', 'catalog15', 'temp.docx')
...
folder_count = len([name for name in os.listdir(archiv_dir) if os.path.isdir(os.path.join(archiv_dir, name))])*15

# 输入单元格
input_text = f"$A$1:$H${folder_count + 1}"
